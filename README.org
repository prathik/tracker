...
2. Start counter
3. Work
4. When counter ends run `tracker increment`
5. Take a 5 minute (or whatever is comfortable) break
6. goto step 1 if done < k or stop

*** Weekly Retro
Post a week of doing this, run `tracker show` to view work done last week and then think about how to optimize for importance (impact) and joy metrics.
